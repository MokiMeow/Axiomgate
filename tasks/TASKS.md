...
- [x] G4 Approval flow: exact command-hash binding, expiry, single-use canonical store, CLI/dashboard/Telegram surfaces, external-reviewer defer routing, redacted stage notifications, and live Telegram card/details/approve/re-tap behavior are verified. Evidence: [`evidence/public/g3-g4-verification.md`](../evidence/public/g3-g4-verification.md), [`evidence/public/guard-closeout-verification.md`](../evidence/public/guard-closeout-verification.md), [`evidence/public/telegram-verification.md`](../evidence/public/telegram-verification.md), `apps/web/test/security.test.mjs`.

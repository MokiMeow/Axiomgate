...
- [-] G4 Approval flow: exact command-hash binding, expiry, single-use canonical store, CLI/dashboard/Telegram surfaces, external-reviewer defer routing, and redacted stage notifications are fixture-verified. The Telegram live card/details/tap proof is PENDING because no valid presenter credential was available at the final gate. Evidence: [`evidence/public/g3-g4-verification.md`](../evidence/public/g3-g4-verification.md), [`evidence/public/guard-closeout-verification.md`](../evidence/public/guard-closeout-verification.md), [`evidence/public/telegram-verification.md`](../evidence/public/telegram-verification.md), `apps/web/test/security.test.mjs`.

...
- [-] G4 Approval flow: exact command-hash binding, expiry, single-use file store, CLI list/approve/deny, external-reviewer defer routing, and the loopback dashboard surface are verified. Only Telegram remains. Evidence: [`evidence/public/g3-g4-verification.md`](../evidence/public/g3-g4-verification.md), [`evidence/public/guard-closeout-verification.md`](../evidence/public/guard-closeout-verification.md), `apps/web/test/security.test.mjs`.

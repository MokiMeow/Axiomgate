...
- Published `axiomgate@0.1.3`, matched its registry shasum to the locally verified tarball, and passed the fresh `npx` doctor, replay, receipt integrity, GitHub head, and README checks.

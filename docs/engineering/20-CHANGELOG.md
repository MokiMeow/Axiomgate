...
- Published the curated source through commit `7d47886` to GitHub `main`. npm publication was authorized but remains blocked until the local registry session is authenticated; no credential discovery or fallback token use was attempted.

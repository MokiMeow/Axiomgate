...
| Environment Guard | IN_PROGRESS | `packages/axiomgate-core/test/identity.test.ts`; `packages/axiomgate-core/test/policy.test.ts`; `evidence/public/g1-g2-verification.md` | G1 identity/target proof and G2 policy evaluation verified; hook enforcement and approvals remain G3–G4 |

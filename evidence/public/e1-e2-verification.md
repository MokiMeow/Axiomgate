...
- Permission-quad mismatches are visible and carried into the receipt. Per `docs/08`, mission completion itself is determined by criterion PASS/WAIVED state; mismatches are not silently discarded.
